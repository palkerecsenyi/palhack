...
/* harmony export */   "default": () => (/* binding */ Amazon)
/* harmony export */ });
...
function _getInfo() {
  _getInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(product) {
    var base, url, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          base = "http://localhost:30000/api/v1/getCarbon";
          url = new URL(base);
...
function getSearchResults() {
  ...
  var result = document.evaluate("//div[@data-component-type='s-search-result']//div[contains(concat(' ', normalize-space(@class), ' '), ' s-title-instructions-style ')]//h2//a", dom, null, XPathResult.ORDERED_NODE_ITERATOR_TYPE, null);
  var node = null;
  var items = [];
...
function showCarbonForSearch(_x2) {
  return _showCarbonForSearch.apply(this, arguments);
}
function _showCarbonForSearch() {
  _showCarbonForSearch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(results) {
    var carbonInfo, item, _item, btn;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          carbonInfo = [];
          _context2.t0 = _regeneratorRuntime().keys(results);
        case 2:
          ...
          _context2.t2 = carbonInfo;
          _context2.t3 = _objectSpread;
          _context2.t4 = _objectSpread({}, item);
          _context2.t5 = {};
          _context2.next = 10;
          return getInfo(name, manufacturer, "");
        case 10:
          _context2.t6 = _context2.sent;
          _context2.t7 = {
            carbon: _context2.t6
          };
          _context2.t8 = (0, _context2.t3)(_context2.t4, _context2.t5, _context2.t7);
          _context2.t2.push.call(_context2.t2, _context2.t8);
          _context2.next = 2;
          break;
        case 16:
          for (_item in results) {
            btn = document.createElement('button');
            btn.setAttribute('content', carbonInfo[_item] + "kg of carbon");
            _item.appendChild(btn);
          }
        case 17:
        case "end":
...
function getOrderConfirmationResults() {
  if (window.location.pathname.startsWith("/gp/buy/thankyou/handlers/display.html")) {
    ...
    var result = document.evaluate("//span[contains(concat(' ', normalize-space(@class), ' '), ' checkout-quantity-badge ')]/..", document, null, XPathResult.ORDERED_NODE_ITERATOR_TYPE, null);
    var node = null;
    var items = [];
    while (node = result.iterateNext()) {
      items.push({
        title: node.firstElementChild.alt,
        url: node.parentElement.href,
        count: parseInt(node.lastElementChild.innerText)
      });
    }
    return items || null;
  } else {
...
function Amazon() {
  return _Amazon.apply(this, arguments);
}
function _Amazon() {
  _Amazon = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var thisProduct, results;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          // entrypoint
          thisProduct = getSearchResults();
          if (thisProduct !== null) {
          ...
          _context3.next = 6;
          return showCarbonForSearch(results);
        case 6:
          console.log((0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.getCurrentResult)());
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _amazon_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./amazon.js */ "./src/extension/amazon.js");

var currentUrl = window.location.origin;
switch (currentUrl) {
  case "https://www.amazon.co.uk":
  case "https://www.amazon.com":
    await (0,_amazon_js__WEBPACK_IMPORTED_MODULE_0__["default"])();
    break;
}
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/extension/index.js");
/******/ 	
/******/ })()
;
