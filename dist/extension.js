  ...
  _getInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(product) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          base = "http://localhost:78393/api/v1/getCarbon";
          url = new URL(base);
...
function showCarbonForProduct(product) {
  var info = getInfo(product.title, product.manufacturer, product.categoryName);
...
function getCurrentResult() {
  ...
  var manufacturer = dom.getElementsByClassName("po-brand")[0].lastElementChild.innerText;
  var series = dom.getElementsByClassName("po-model_name")[0].lastElementChild.innerText;
  ...
  var price = originalPrice.length ? originalPrice[0].innerText : dom.getElementById("corePrice_feature_div").getElementsByClassName("a-offscreen")[0].innerText;
  var categoryNumber = document.getElementById("searchDropdownBox").dataset["nav-selected"];
